  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'navy-dark': 'hsl(199 74% 9%)',
        'blue-medium': 'hsl(199 58% 27%)',
        'teal-sage': 'hsl(183 23% 48%)',
        'gray-light': 'hsl(180 4% 95%)'
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'pulse-glow-logo': {
          '0%, 100%': { opacity: '1', filter: 'brightness(0) invert(1) drop-shadow(0 0 8px rgba(255,255,255,0.8))' },
          '50%': { opacity: '0.8', filter: 'brightness(0) invert(1) drop-shadow(0 0 20px rgba(255,255,255,0.4))' },
        },
        'spin-slow': {
      ...
      animation: {
        ...
        'pulse-glow-logo': 'pulse-glow-logo 2s ease-in-out infinite',
